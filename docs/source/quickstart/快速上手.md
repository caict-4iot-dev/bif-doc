...
用户在**测试网**上部署、调用、 查询一个`Javascript`、`Solidity`智能合约，需要完成如下工作：

1. 获取星火令来激活账户
2. Java sdk的初始化
3. 通过测试网节点/`Quicknode`节点部署合约
