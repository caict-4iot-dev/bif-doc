...
见[交易费用设置建议](星火链底层区块链平台介绍.md#gas_gasprice)。

### 4.3.4 可信认证申请多久可以通过审核

体验网的个人可信认证一般一周会审核1-2次，着急的话可以加入[星火链技术交流群](星火链底层区块链平台介绍.md#lianxiwomen)联系技术人员尽快处理，企业认证需要加入[星火链技术交流群](星火链底层区块链平台介绍.md#lianxiwomen)联系业务人员尽快处理。
